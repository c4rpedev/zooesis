    ...
    export async function interpretValues(valuesData, analysisType, language) {
      if (!genAI) throw new Error("Gemini AI SDK not initialized. Check API Key.");
    ...
    export async function interpretHemogramValues(valuesData, language = 'en') {
      return interpretValues(valuesData, 'hemogram', language);
    }
